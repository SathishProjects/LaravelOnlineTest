                    ...
                    <div class="tab-content tabs-login col-lg-12 col-md-12 col-sm-12 cols-xs-12">
                        <div id="student-access" class="tab-pane fade active in">
                            ...
                            <div class="row">
                                <div class="col-md-12 bg-danger padding15px">
                                    ...
                                    <a href="http://test.first.jobs/index.php/testlogin/{!! $details['url'] !!}" target="_blank">http://test.first.jobs/index.php/testlogin/{!! $details['url'] !!}</a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                        ...
                        <div class="tab-content tabs-login col-lg-12 col-md-12 col-sm-12 cols-xs-12">
                            <div id="student-access" class="tab-pane fade active in">
                                ...
                                <a href="javascript: window.history.go(-1)"><i class="fa fa-arrow-left"></i> Back</a>
                            </div>
                        </div>
                    @endif
                </section>
