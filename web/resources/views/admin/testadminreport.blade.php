    ...
    <div class="homecontainer container">
        <div class="row">
            <ul class="breadcrumb margintop1">
                <li><a href="/index.php/testlogin_admin/{{ $testdetails[0]->testinstance }}">Home</a></li>
        ...
        <div class="row">
            ...
            <table class="table table-bordered">
                ...
                <tr class="row_hover" onclick="location.href='/index.php/admin/individual_testreport/{!! $testdetails[0]->testinstance !!}/{!! $sdval->student_id !!}'">
                    <td>{!! $sdkey+1 !!}</td>
