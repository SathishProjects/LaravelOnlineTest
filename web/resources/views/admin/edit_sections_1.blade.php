								...
								<div class="panel-body">
									...
									<div class="row">
										<center>
											...
											@endforeach
												@if($remaining != 0)
											<a href="/index.php/{!!$details->qp_id !!}/college/set_section" class="btn btn2 href2">Add New Section</a>
												@endif
											@if($section)
												<a href="/index.php/{!!$details->qp_id !!}/college/set_questions/1/1" class="btn btn1 href1">View / Edit Question Paper</a>
											@else
												<a href="/index.php/{!!$details->qp_id !!}/college/edit_questionpaper" class="btn btn-default" >Cancel</a>
											@endif
