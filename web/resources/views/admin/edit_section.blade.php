								...
								<div class="panel-body">
									...
									<div class="">
											...
											<div class="col-md-12">
												<div class="col-md-12">
													...
													<div class="form-group">
														...
														<textarea class="form-control editable"  name="section_hint" placeholder="Answer hints for division ( Optional )"  >{!! $section_value->section_hint !!}</textarea>
													</div>
										...
										<center>
											...
											@if($remaining)
											<button class="btn btn1" type="submit" name="action" value="2">Update & Add New Division</button>
											@endif
