                                    ...
                                    <div class="panel-group">
                                        <div class="panel panel-default ">
                                            ...
                                            <div class="panel-body qn-panel">
                                                <p><b>Which of the figures, you think best fits the series below?</b></p>
                                                <img src="/images/sample4.gif" class="img-responsive"><br><br>
                                                <form role="form">
                                                    <div class="radio">
                                                        <label><input type="radio" name="optradio"><img src="/images/sample.gif"></label>
                                                    </div>
                                                    <div class="radio">
                                                        <label><input type="radio" name="optradio"><img src="/images/sample1.gif"><br></label>
                                                    </div>
                                                    <div class="radio">
                                                        <label><input type="radio" name="optradio"><img src="/images/sample2.gif"></label>
                                                    </div>
                                                    <div class="radio">
                                                        <label><input type="radio" name="optradio"><img src="/images/sample3.gif"><br></label>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="panel-body bgc_gray">
                                                {{--<button type="button" class="btn btn2">Mark for Review</button>--}}
                                                <center><a href="/index.php/page1" type="button" class="btn btn1 href1 pull-right">Save & Next</a></center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
