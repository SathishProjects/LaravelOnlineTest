                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12 zeropadding">
                                            ...
                                            <div class="question">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                    <textarea class="form-control editable" placeholder="Question answer / hint" name="question_hint">{!! $current_question->question_hint !!}</textarea>
                                                    </div>
                                                </div>
                                                @if($current_question->question_type == 2)
