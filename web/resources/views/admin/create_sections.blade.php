						...
						<div class="panel panel-default">
							<div class="panel-heading panelcolor1">
								<h4 class="panel-title">
									<i class="fa fa-code-fork"></i> Division Details
								</h4>
							</div>
									...
									<div class="">
											...
											<div class="col-md-12">
												<div class="col-md-12">
													...
													<div class="form-group">
														<label for="title">Division Instructions:</label>
													...
													<span class="help-block"> <b>NOTE : </b> Each division can cantain only one comprehention question (or) Questions based on given paragraph </span>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											<div class="col-md-12">
												<div class="col-md-12">
													...
													<div class="form-group">
														<label for="title">Division answer / hint:</label>
														
														<textarea class="form-control editable"  name="section_hint" placeholder="Answer hints for division ( Optional )"  ></textarea>
													</div>
										...
										<div class="form-group row">
											<div class="col-md-12">
												<div class="form-group">
													<div class="col-xs-4">
														<label for="title">Division type: </label>
													</div>
													<div class="col-xs-8">
											...
											<div class="question_image" hidden>
												<div class="col-xs-12">
													...
													<span class="file-input btn btn2 btn-block btn-primary btn-file">
                											Click here to upload Division image <input type="file" name="question_image" multiple data-bv-excluded="false">
            										</span>
													<br><label class="question_image_view" hidden>Division Image :</label>
													<center>
											...
											<div class="col-md-12">
												...
												<div class="form-group">
													<div class="col-sm-4 col-xs-6">
														<label for="title">No.of.Qns in Division : </label>
													</div>
													<div class="col-sm-5 col-xs-3">
														<input type="hidden" class="section_count" value="{!! count($section) !!}">
										...
										<center>
											...
											@else
												<a href="/index.php/{!!$details->qp_id !!}/college/edit_questionpaper" class="btn btn2" >Cancel</a>
											@endif
										</center>
						...
						<div class="panel panel-default">
							...
							<div  class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="row">
										<div class="col-xs-12">
											<a href="/index.php/{!!$details->qp_id !!}/college/edit_questionpaper" class="href1"><i class="fa fa-pencil-square-o"></i> Edit Question Paper</a>
										</div>
									</div>
									<div class="well">
													...
													<div class="panel panel-default">
														<div class="panel-heading panelcolor2">
															<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#{!! "section".$key !!}">
																<h4 class="panel-title">Division {!! $value -> section_value !!} details</h4>
															</a>
														</div>
														<div id="{!! "section".$key !!}" class="panel-collapse collapse">
															<div class="panel-body">
																...
																<hr>
																<div class="form-group row">
																	<label class="col-xs-6">Division Type :</label>
																<span class="col-xs-6">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<a type="button" class="btn btn1 href1" href="/index.php/{!!  $details->qp_id !!}/college/set_questions/1/1">Yes</a>
...
<div class="modal fade" id="section_delete" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					<h4>Are you sure to delete the Division?</h4>
					<form action="/index.php/college/delete_section" method="post">
						<input type="hidden" name="qp_id" value="{!! $details->qp_id !!}">
