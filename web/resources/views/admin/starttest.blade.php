...
@section('content')
	...
	<div class="container" xmlns="http://www.w3.org/1999/html">
		...
		<div class="row">
	 	<div class="col-md-12">
										<a href="/index.php/auth/logout" class="pull-right">Logout</a>
									</div></div>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<br>
												...
												<a href="/index.php/goto_test_details/{!! $id !!}" type="button" class="btn btn1 href1 terms_btn" disabled onClick="return popup(this, 'notes')">Start test..</a>
