...
<div class="container">
        <div class="row fj_mrg_1">
          <ol class="breadcrumb breadcrumb-arrow">          
            <li><a href="../college/dashboard" class="fj_fnt_6 fj_color_1"> <i class="glyphicon glyphicon-arrow-left"></i> back</a></li>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="container fj_pad_0" id="main">
					<div class="row">
					   <div class="col-md-12 fj_pad_0">
					   		<div class="row">
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_8"> Android Drive</div>
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_6" align="center"><span class="badge">52</span> Eligible | <span class="badge">38</span> Applied</div>
					        <div class="col-lg-4 col-md-4 col-sm-4">
					       <!--  <div class="pull-right btn-group">
										  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										    Notify to <span class="caret"></span>
										  </button>
										  <ul class="dropdown-menu">
										    <li><a href="#">Eligible Students</a></li>
										    <li><a href="#">Company</a></li>
										  </ul>
										</div> -->
								  <h4 class="pull-right fj_color_1">Interview On-going</h4>
					   ...
					   <div class="col-md-5 col-sm-6">
					     ...
					     <div class="col-md-12 col-sm-12">
									 ...
									 <h4 class="fj_color_1">Interview On-going</h4>
						            </div>
            ...
            <div class="col-md-12">
                <div class="container fj_pad_0" id="main">
					<div class="row">
					   <div class="col-md-12 fj_pad_0">
					   		<div class="row">
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_8"> Aptitude Test</div>
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_6" align="center"><span class="badge">21</span> Eligible | <span class="badge">20</span> Applied | <span class="badge">10</span> Shortlisted</div>
					        <div class="col-lg-4 col-md-4 col-sm-4">
					         <!-- Single button -->
								<!-- <div class="pull-right btn-group">
								  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-md-12">
                <div class="container fj_pad_0" id="main">
					<div class="row">
					    <div class="col-md-12 fj_pad_0">
					   		<div class="row">
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_8"> Technical Test</div>
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_6" align="center"><span class="badge">10</span> Eligible | <span class="badge">10</span> Applied | <span class="badge">4</span> Shortlisted</div>
					        <div class="col-lg-4 col-md-4 col-sm-4">
					            <!-- Single button -->
								<!-- <div class="pull-right btn-group">
								  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
Et mei vidit timeam liberavisse. Dicam cetero et sed, vide melius deserunt cum ea, mea illud salutandi cu. Ius agam velit no. Eos sint saperet appetere ea, quem odio probo vim ei. Ut nec tibique indoctum. Aeque cetero fabellas te nec. Duis saperet intellegam et nec, nam feugiat propriae perfecto in.
					   ...
					   <div class="col-md-5 col-sm-6">
					     ...
					     <div class="col-md-12 col-sm-12">
									...
									<!-- end of Single button -->
									<h4 class="fj_color_1"><span class="badge">4</span> Shortlisted</h4>
						            </div>
            ...
            <div class="col-md-12">
                <div class="container fj_pad_0" id="main">
					<div class="row">
					    <div class="col-md-12 fj_pad_0">
					   		<div class="row">
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_8"> HR Round</div>
					        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 fj_fnt_6" align="center"><span class="badge">4</span> Eligible | <span class="badge">2</span> Applied</div>
					        <div class="col-lg-4 col-md-4 col-sm-4">
					         <!-- Single button -->
								<div class="pull-right btn-group">
								  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
