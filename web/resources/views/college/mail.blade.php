          ...
          <div class="panel-heading fj_border_bottom_1 fj_pad_15">
            <div class="row">
              <div class="col-xs-6" align="center">
                <a href="#" class="active" id="login-form-link">Compose Mail</a>
              </div>
              <div class="col-xs-6" align="center">
                <a href="#" id="register-form-link">Bulk Mail</a>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-12">
                 ...
                 <div class="tab-pane" id="compose">
                      ...
                      <div class=" clearfix">
                          <div class="col-md-12 content-container">
                           <h4 class="content-title" align="center">Compose Mail</h4>
                          
                              <div class="form-group">
                              <h5>To</h5>
                                  <input id="tokenfield" type="text" class="form-control" placeholder="Enter email address and hit enter" />
                                  <h5 align="right">Note :<b class="fj_color_1"> Type email address and hit enter</b></h5>
                              </div>
                ...
                <form id="register-form" action="" method="post" role="form" style="display: none;">
                   <div class="tab-pane" id="compose">
                      ...
                      <div class=" clearfix">
                          <div class="col-md-12 content-container">
                           <h4 class="content-title" align="center">Bulk Mail</h4>
