							...
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>TEST URL </label> <span class="note">*</span>
												<input type="text" name="test_url" class="form-control" value="http://localhost:8085/index.php/attendtest/{!! $test_id !!}" readonly />
											</div>
										</div>
									</div>
									...
									<center>
										...
										<button class="btn btn1 submit_btn" type="submit" disabled>Save & Proceed</button>
										<button class="btn btn2 " type="reset" >Reset</button>
									</center>
								</div>
							</div>
						</div>
